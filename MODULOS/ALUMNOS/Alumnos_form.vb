...
Public Class Alumnos_form
    ...
    Private Sub GUARDARToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GUARDARToolStripMenuItem.Click
        Try
            ...
            cmd.Parameters.AddWithValue("@Fecha_de_nacimiento", "")

            cmd.Parameters.AddWithValue("@Estado_civil", "")
            ...
            cmd.Parameters.AddWithValue("@Distrito", "")
            cmd.Parameters.AddWithValue("@Direccion", "")
            cmd.Parameters.AddWithValue("@Departamento2", "")
            cmd.Parameters.AddWithValue("@Provincia2", "")
            cmd.Parameters.AddWithValue("@Distrito2", "")
            ...
            cmd.Parameters.AddWithValue("@Local_studio", "")


            cmd.Parameters.AddWithValue("@Fecha_de_Matricula", "")
            cmd.Parameters.AddWithValue("@Fecha_de_Inicio", "")
